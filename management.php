     ...
     <main role="main">
         ...
         <?php
             if(isset($_SESSION['id']) && $_SESSION['id']=="bi0416"){
                    ?>
        <div class="container h1 mt-4 mb-4 text-center">사용자 관리 : <?php echo $_GET['id']; ?></div>
        <div class="container">
            <?php
            ...
            ?>
            <form method="post" action="management_ok.php" name="managementform" id="managementform" class="container">
                <div class="form-group row">
                    <label for="" class="col-sm-2 col-form-label">아이디</label>
                    <div class="col-sm-10">
                        <input type="text" id="identy" name="identy" class="form-control" value="<?php echo $row['id']; ?>">
                    </div>
                </div>
                <div class="form-group row">
