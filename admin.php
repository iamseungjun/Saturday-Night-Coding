                        ...
                        <tbody>
                            <?php
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr role=\"row\"><th scope=\"row\">".$i."</th><td>".$row['name']."</td><td>".$row['year']."</td><td>".$row['id']."</td><td>".$row['email']."</td><td>".$row['rating']."</td><td>".$row['tier']."</td><td><a href=\"management.php?id=".$row['id']."\" class=\"btn btn-primary\">확인</a></td></tr>";
                                    $i+=1;
                                }
                            ?>
                        </tbody>
